...
const PeriodPropertyRenovationLondon = () => {
  return (
    <>
      <SEO
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <h1 className="text-4xl md:text-5xl font-light tracking-[0.2em] text-gray-900 font-serif mb-6">
              PERIOD PROPERTY RENOVATION LONDON
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl leading-relaxed">
              Sensitive renovation of London's period properties including Georgian, Victorian, and Edwardian homes. We combine traditional craftsmanship with modern functionality while preserving historic character across all London boroughs.
            </p>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <h2 className="text-3xl font-light tracking-[0.2em] text-gray-900 font-serif mb-12 text-center">
              PERIOD PROPERTY RENOVATION SERVICES
            </h2>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  title: "Georgian Property Renovation",
                  description: "Expert renovation of Georgian properties maintaining architectural integrity and period features."
                },
                {
                  title: "Edwardian House Renovation",
                  description: "Sensitive renovation of Edwardian homes preserving original character and craftsmanship."
                },
                {
                  title: "Period Feature Restoration",
                  description: "Restore original period features including moldings, fireplaces, and architectural details."
                },
                {
                  title: "Historic Building Modernization",
                  description: "Modernize period properties with contemporary amenities while maintaining historic character."
                },
                {
                  title: "Conservation Area Compliance",
                  description: "Navigate conservation area requirements and planning permissions for period properties."
                },
                {
                  title: "Traditional Building Techniques",
                  description: "Use authentic materials and traditional building techniques for period property renovation."
                }
              ].map((service, index) => (
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <h2 className="text-3xl font-light tracking-[0.2em] text-gray-900 font-serif mb-12 text-center">
              PERIOD PROPERTY RENOVATION AREAS IN LONDON
            </h2>
        ...
        <section className="py-16 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get your free consultation and detailed quote for your London period property renovation project.
            </p>
...
export default PeriodPropertyRenovationLondon;
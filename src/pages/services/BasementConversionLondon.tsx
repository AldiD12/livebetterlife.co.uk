...
const BasementConversionLondon = () => {
  return (
    <>
      <SEO
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl leading-relaxed">
              Transform your London basement into valuable living space with our expert conversion services. We specialize in basement excavation, waterproofing, and complete conversions across all London boroughs.
            </p>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  description: "Professional basement excavation to create additional headroom and usable space."
                },
                {
                  title: "Waterproofing Systems",
                  description: "Advanced waterproofing solutions to ensure your basement remains dry and habitable."
                },
                {
                  title: "Basement Extension",
                  description: "Extend your basement under gardens and adjacent areas to maximize space."
                },
                {
                  title: "Underpinning Services",
                  description: "Foundation underpinning to safely lower basement floors and increase ceiling height."
                },
                {
                  title: "Basement Design & Planning",
                  description: "Complete design service with planning permission and building regulations approval."
                },
                {
                  title: "Basement Finishing",
                  description: "Complete finishing including flooring, lighting, heating, and ventilation systems."
                }
              ].map((service, index) => (
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <h2 className="text-3xl font-light tracking-[0.2em] text-gray-900 font-serif mb-12 text-center">
              BASEMENT CONVERSION AREAS IN LONDON
            </h2>
        ...
        <section className="py-16 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
            <h2 className="text-3xl font-light tracking-[0.2em] font-serif mb-6">
              READY FOR YOUR BASEMENT CONVERSION?
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Get your free consultation and detailed quote for your London basement conversion project.
            </p>
...
export default BasementConversionLondon;